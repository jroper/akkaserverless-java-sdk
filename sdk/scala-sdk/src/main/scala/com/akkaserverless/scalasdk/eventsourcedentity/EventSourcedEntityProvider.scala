...
abstract class EventSourcedEntity[S] extends EntityImpl[S]

class EventSourcedEntityProvider[S, E <: EventSourcedEntity[S]](private[akkaserverless] val impl: Impl[S, E])
